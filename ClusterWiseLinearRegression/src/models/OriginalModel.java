...
public class OriginalModel {
	...
	public void buildModel(String path, Params...params) throws IOException, GRBException{

		this.ds = new DataSource(path);
		...
		this.vars = new ModelVars();
		this.vars.GenVars(this.model, this.ds, params);
		//this.constraints = new ModelConstraints(this.model, this.ds, this.vars);
		this.constraints = new ModelConstraints(this.model, this.ds, this.vars, params);
		this.obj = new ModelQPObj(this.model, this.ds, this.vars);
	...
	public void exportLP(String LPFileName) throws GRBException {
		this.model.write(LPFileName);
	}
